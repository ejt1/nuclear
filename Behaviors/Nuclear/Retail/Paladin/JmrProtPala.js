  ...
  cooldowns() {
    ...
    defensives() {
        return new bt.Selector(
            ...
            spell.cast("Ardent Defender", on => me, req => me.healthPercent < 20),
            spell.cast("Guardian of Ancient Kings", on => me, req => me.healthPercent < 30),
            spell.cast("Lay on Hands", on => me, req => me.healthPercent < 10),
            spell.cast("Divine Shield", on => me, req => me.healthPercent < 10),
            spell.cast("Word of Glory", on => me, req => me.healthPercent < 50),
        );
    }
    ...
    standard() {
        return new bt.Selector(
            ...
            spell.cast("Hammer of Light", on => this.currentorbestTarget(), req => this.currentorbestTarget() !== null && (me.hasVisibleAura(427441) && me.getAuraByMe(427441).remaining < 2000 || (me.hasVisibleAura(431533) && me.getAuraByMe(431533).remaining < 1000) || !me.hasVisibleAura(431533) || spell.getCooldown("Eye of Tyr").timeleft < 1500)),
            ...
            spell.cast("Sacred Weapon", on => me, req => spell.getCharges("Sacred Weapon") === 2),
            ...
            spell.cast("Consecration", on => me, req => !me.hasVisibleAura(188370) || me.getAuraByMe(188370).remaining < 100),
