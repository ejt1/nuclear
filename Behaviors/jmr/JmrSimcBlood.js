      ...
      new bt.Decorator(
        ...
        new bt.Selector(
          ...
          spell.cast("Death Grip",
            on => this.getValidTarget(unit => unit.inCombat() && unit.distanceTo(me) <= 30 && !unit.isTanking()),
            req => this.getValidTarget(unit => unit.inCombat() && unit.distanceTo(me) <= 30 && !unit.isTanking()) !== undefined && spell.getCharges("Death Grip") > Settings.JmrDeathGripCharges && spell.getCharges("Death Grip") >= 1),
